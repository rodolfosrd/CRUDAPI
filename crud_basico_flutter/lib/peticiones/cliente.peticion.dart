...
Future<List<Client>> listClient() async {
  final response =
      await http.get(Uri.parse('http://localhost:3000/api/clientes'));
  print(response.body);
...
Future<Client> addClient(Client client) async {
  var url = Uri.parse('http://localhost:3000/api/clientes/registro');
...
Future<Client> deleteClient(String clientId) async {
  ...
  final http.Response response = await http.delete(
    Uri.parse('http://localhost:3000/api/clientes/eliminar/$clientId'),
...
Future<Client> modifyClient(Client client) async {
  var url = Uri.parse('http://localhost:3000/api/clientes/modificar');
